...
public class ChatServer {
    public static final int portNum = Config.getAsInt("config.txt", "ServerPortNum");
    ...
    public static void main(String[] argv){
        String serverpub = Config.getAsString("serverkey.txt", "Pub");
        String serverpri = Config.getAsString("serverkey.txt", "Pri");
        new ChatServer(serverpri.getBytes());
    }
